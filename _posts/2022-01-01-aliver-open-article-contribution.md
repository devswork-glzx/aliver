...
针对文档排版，如果你使用 Word 或 RTF 格式，请**不要使用其他第三方字体**，以方便文章投稿。同时，请不要采用分栏、文本框等功能，以免影响文章效果。
...
- 恶意删除 / 屏蔽某个人的名字（举个例子，你非常讨厌张三，然后在文章中将“张三”替换成 XXX）
- **尤其是**对校领导的恶意谩骂
...
此外，您不应恶意给其他人的肖像打码（例如，你很讨厌 XXX，但你照样不能以“护眼”为由将其打码）。您只能出于隐私保护（或者防社死）目的给他人打码。
