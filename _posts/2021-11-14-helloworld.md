...
如果您不使用 Git / GitHub / Gitee，我将与您使用 QQ 联系（我的 QQ 将在邮件回复中发送给您），届时您可以使用 QQ 向我发送稿件。请注意，稿件应采用 Word（`.doc` / `.docx`）、纯文本（`.txt`）或 Markdown（`.md`）格式。
...
> 本段参考了 [温州市第五十一中学新生导引 联系我们](https://www.wz51z.wiki/联系我们.html) 页面。
